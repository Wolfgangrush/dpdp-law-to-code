...
def check_fiduciary_accountability(
    ...
    if processing_by_processor_on_behalf:
        sub.append(
            ComplianceResult(
                ...
                section="Sec 8(1)",
                reason=(
                    "Data Fiduciary responsible for processing undertaken by Data Processor on its behalf"
    ...
    return ComplianceResult(
        ...
        section="Sec 8(1)",
        reason=(
            "Data Fiduciary accountability confirmed"
            if all_pass
...
def check_processor_contract(
    ...
    return ComplianceResult(
        ...
        section="Sec 8(2)",
        reason=(
            "Data Processor engaged under valid contract"
...
def check_data_accuracy_completeness(
    ...
    return ComplianceResult(
        ...
        section="Sec 8(3)",
        reason=(
            "accuracy, completeness and consistency ensured"
            if all_pass
            else f"{len(failed)} data-quality requirement(s) failed: "
...
def check_compliance_measures(
    ...
    sub.append(
        ComplianceResult(
            ...
            section="Sec 8(4)",
            reason=(
                "appropriate organisational measures implemented"
                if has_organisational_measures
    ...
    return ComplianceResult(
        ...
        reason=(
            ...
            if all_pass
            else f"{len(failed)} compliance-measure requirement(s) failed: "
            + "; ".join(r.reason for r in failed)
        ),
        citation="DPDP Act 2023, Sec 8(4)",
        sub_results=sub,
...
def check_security_safeguards(
    ...
    sub.append(
        ComplianceResult(
            ...
            section="Sec 8(5)",
            reason=(
                "organisational safeguards in place"
                if has_organisational_safeguards
    ...
    sub.append(
        ComplianceResult(
            ...
            reason=(
                ...
                if has_regular_security_audits
    ...
    return ComplianceResult(
        ...
        reason=(
            ...
            if all_pass
            else f"{len(failed)} security-safeguard requirement(s) failed: "
            + "; ".join(r.reason for r in failed)
        ),
        citation="DPDP Act 2023, Sec 8(5)",
        sub_results=sub,
...
def check_breach_notification(breach: BreachRecord) -> ComplianceResult:
    ...
    board_compliant = (
        ...
        and (breach.notified_board_at_unix - breach.detected_at_unix)
        <= _BREACH_NOTIFY_BOARD_SECONDS
    )
    sub.append(
        ComplianceResult(
            ...
            section="Sec 8(6)",
            reason=(
                "Board notified within heuristic 72hr window"
                if board_compliant
    ...
    principal_compliant = (
        ...
        and (breach.notified_affected_principals_at_unix - breach.detected_at_unix)
        <= _BREACH_NOTIFY_PRINCIPAL_SECONDS
    )
    sub.append(
        ComplianceResult(
            ...
            section="Sec 8(6)",
            reason=(
                "affected Data Principals notified within heuristic 72hr window"
                if principal_compliant
    ...
    return ComplianceResult(
        ...
        section="Sec 8(6)",
        reason=(
            "breach notification timely to Board and affected Data Principals"
            if all_pass
            else "; ".join(r.reason for r in sub if not r.compliant)
        ),
        citation="DPDP Act 2023, Sec 8(6)",
...
def check_erasure_on_withdrawal(erasure: ErasureContext) -> ComplianceResult:
    ...
    return ComplianceResult(
        ...
        section="Sec 8(7)(a)",
        reason=(
            "personal data erased upon withdrawal or purpose served"
            if erasure.fiduciary_erased
...
def check_processor_erasure(erasure: ErasureContext) -> ComplianceResult:
    ...
    return ComplianceResult(
        ...
        section="Sec 8(7)(b)",
        reason=(
            "Data Processor caused to erase personal data"
            if erasure.processor_erased
...
def check_dpo_contact_publication(
    ...
    sub.append(
        ComplianceResult(
            ...
            section="Sec 8(8)",
            reason=(
                "DPO or authorised person business contact information published"
                if dpo_contact_published
    ...
    sub.append(
        ComplianceResult(
            ...
            section="Sec 8(8)",
            reason=(
                "contact published in prescribed manner"
                if contact_in_prescribed_manner
    ...
    return ComplianceResult(
        ...
        section="Sec 8(8)",
        reason=(
            "DPO contact publication requirements met"
            if all_pass
            else f"{len(failed)} DPO-contact requirement(s) failed: "
            + "; ".join(r.reason for r in failed)
        ),
        citation="DPDP Act 2023, Sec 8(8)",
        sub_results=sub,
...
def check_grievance_mechanism(
    ...
    sub.append(
        ComplianceResult(
            ...
            section="Sec 8(9)",
            reason=(
                "mechanism is effective — grievances tracked, escalated and resolved"
                if mechanism_is_effective
    ...
    sub.append(
        ComplianceResult(
            ...
            section="Sec 8(9)",
            reason=(
                "mechanism accessible to Data Principals"
                if mechanism_accessible_to_principals
    ...
    return ComplianceResult(
        ...
        section="Sec 8(9)",
        reason=(
            "effective grievance redressal mechanism established"
            if all_pass
            else f"{len(failed)} grievance-mechanism requirement(s) failed: "
            + "; ".join(r.reason for r in failed)
        ),
        citation="DPDP Act 2023, Sec 8(9)",
        sub_results=sub,
...
def check_grievance_redressal(
    ...
    within_period = (
        grievance_responded_at_unix - grievance_received_at_unix
    ) <= max_seconds
    ...
    return ComplianceResult(
        ...
        section="Sec 8(10)",
        reason=(
            f"grievance responded to within {resolution_period_days}-day prescribed period"
            if within_period
...
def check_additional_obligations(
    ...
    return ComplianceResult(
        ...
        section="Sec 8(11)",
        reason=(
            f"all {len(obligations)} notified additional obligation(s) complied with"
            if all_obligations_complied
...
def check_fiduciary_compliance(
    ...
    return ComplianceResult(
        ...
        section="Sec 8",
        reason=(
            "All Sec 8(1)-(11) fiduciary obligations met"
            if all_pass
            else f"{len(failed)} Sec 8 obligation(s) failed: "
            + "; ".join(r.reason for r in failed)
        ),
        citation="DPDP Act 2023, Sec 8",
        sub_results=sub,
