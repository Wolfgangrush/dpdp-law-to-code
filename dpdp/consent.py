...
_F_S_I_U_U = (
    ...
    ("is_unconditional", "Unconditional", "consent not made conditional on unrelated terms"),
...
def check_consent(consent: ConsentRecord) -> ComplianceResult:
    ...
    for attr, label, requirement in _F_S_I_U_U:
        ...
        sub.append(ComplianceResult(
            compliant=present,
            section="Sec 6(1)",
            reason=(f"{label}: satisfied" if present else f"{label}: not satisfied — {requirement}"),
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(1)",
        reason=("clear affirmative action present" if consent.has_clear_affirmative_action
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(1)",
        reason=("not pre-checked" if not consent.is_pre_checked
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(1)",
        reason=("limited to specified purpose" if consent.is_limited_to_specified_purpose
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(1)",
        reason=("not bundled with unrelated terms" if not consent.is_bundled_with_unrelated_terms
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(2)",
        reason=("no infringing provision" if not consent.has_infringing_provision
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(3)",
        reason=("consent request in clear and plain language" if consent.request_in_clear_plain_language
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(3)",
        reason=("Eighth Schedule language option given" if consent.has_eighth_schedule_language_option
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(3)",
        reason=("DPO or authorised person contact provided" if consent.dpo_contact_provided
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(4)",
        reason=("withdrawal as easy as giving consent" if consent.is_withdrawable_easily
    ...
    return ComplianceResult(
        compliant=all_pass,
        section="Sec 6",
        reason=("All Sec 6(1)-(4) consent requirements met" if all_pass
                else f"{len(failed)} requirement(s) failed: " + "; ".join(r.reason for r in failed)),
        citation="DPDP Act 2023, Sec 6",
        sub_results=sub,
    )
...
def check_withdrawal_ease(consent: ConsentRecord) -> ComplianceResult:
    ...
    return ComplianceResult(
        compliant=consent.is_withdrawable_easily,
        section="Sec 6(4)",
        reason=("withdrawal as easy as grant" if consent.is_withdrawable_easily
...
def check_infringing_consent(has_infringing_provision: bool) -> ComplianceResult:
    ...
    return ComplianceResult(
        ...
        section="Sec 6(2)",
        reason=("no infringing provision" if not has_infringing_provision
...
def check_consent_request_presentation(
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(3)",
        reason=("clear and plain language used" if clear_plain_language
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(3)",
        reason=("Eighth Schedule language option given" if eighth_schedule_option
                else "must provide option to access request in English or Eighth Schedule language"),
        citation="DPDP Act 2023, Sec 6(3)",
    ))
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(3)",
        reason=("DPO or authorised person contact provided" if dpo_contact_provided
    ...
    return ComplianceResult(
        compliant=all_pass,
        section="Sec 6(3)",
        reason=("consent request meets all Sec 6(3) requirements" if all_pass
                else f"{len(failed)} Sec 6(3) requirement(s) failed: " + "; ".join(r.reason for r in failed)),
        citation="DPDP Act 2023, Sec 6(3)",
        sub_results=sub,
    )
...
def check_withdrawal_consequences(
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(5)",
        reason=("Data Principal informed consequences of withdrawal are borne by her"
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(5)",
        reason=("pre-withdrawal processing treated as lawful" if pre_withdrawal_processing_treated_lawful
    ...
    return ComplianceResult(
        compliant=all_pass,
        section="Sec 6(5)",
        reason=("Sec 6(5) withdrawal consequences requirements met" if all_pass
                else f"{len(failed)} Sec 6(5) requirement(s) failed: " + "; ".join(r.reason for r in failed)),
        citation="DPDP Act 2023, Sec 6(5)",
        sub_results=sub,
    )
...
def check_cessation_on_withdrawal(
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(6)(a)",
        reason=("Data Fiduciary ceased processing within reasonable time" if df_ceased_processing
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(6)(b)",
        reason=("Data Fiduciary caused processors to cease" if df_caused_processors_to_cease
    ...
    return ComplianceResult(
        compliant=all_pass,
        section="Sec 6(6)",
        reason=("processing ceased on withdrawal" if all_pass
                else f"{len(failed)} cessation requirement(s) failed: " + "; ".join(r.reason for r in failed)),
        citation="DPDP Act 2023, Sec 6(6)",
        sub_results=sub,
    )
...
def check_consent_via_consent_manager(
    ...
    return ComplianceResult(
        ...
        section="Sec 6(7)",
        reason=("Data Fiduciary honours consent given via Consent Manager"
...
def check_consent_manager_accountability(
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(8)",
        reason=("Consent Manager accountable to Data Principal" if is_accountable_to_data_principal
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(8)",
        reason=("Consent Manager acts on behalf of Data Principal" if acts_on_behalf_of_data_principal
    ...
    return ComplianceResult(
        compliant=all_pass,
        section="Sec 6(8)",
        reason=("Consent Manager meets Sec 6(8) obligations" if all_pass
                else f"{len(failed)} Sec 6(8) requirement(s) failed: " + "; ".join(r.reason for r in failed)),
        citation="DPDP Act 2023, Sec 6(8)",
        sub_results=sub,
    )
...
def check_consent_manager_registration(
    ...
    return ComplianceResult(
        ...
        section="Sec 6(9)",
        reason=("Consent Manager registered with the Board" if is_registered_with_board
...
def check_burden_of_proof(
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(10)",
        reason=("Data Fiduciary can prove notice was given to Data Principal" if notice_given
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(10)",
        reason=("Data Fiduciary can prove consent was obtained from Data Principal" if consent_obtained
    ...
    sub.append(ComplianceResult(
        ...
        section="Sec 6(10)",
        reason=("burden of proof evidence available" if evidence_present
    ...
    return ComplianceResult(
        compliant=all_pass,
        section="Sec 6(10)",
        reason=("burden of proof discharged" if all_pass
                else f"{len(failed)} burden-of-proof requirement(s) failed: " + "; ".join(r.reason for r in failed)),
        citation="DPDP Act 2023, Sec 6(10)",
        sub_results=sub,
    )
