...
def check_notice_describes_data(notice: NoticeRecord) -> ComplianceResult:
    ...
    sub.append(
        ComplianceResult(
            ...
            reason=(
                ...
                if notice.describes_personal_data
    ...
    return ComplianceResult(
        ...
        section="Sec 5(1)(i)",
        reason=(
            "notice describes personal data and purpose"
            if all_pass
            else f"{len(failed)} ingredient(s) missing: "
...
def check_notice_rights_exercise(notice: NoticeRecord) -> ComplianceResult:
    ...
    return ComplianceResult(
        ...
        section="Sec 5(1)(ii)",
        reason=(
            "describes manner of exercising rights under Sec 6(4) and Sec 13"
...
def check_notice_board_complaint(notice: NoticeRecord) -> ComplianceResult:
    ...
    return ComplianceResult(
        ...
        section="Sec 5(1)(iii)",
        reason=(
            "describes manner of complaint to Board"
...
def check_notice_timing(notice: NoticeRecord) -> ComplianceResult:
    ...
    return ComplianceResult(
        ...
        section="Sec 5(1)",
        reason=(
            "notice given before or at the time of consent request"
...
def check_notice_language(notice: NoticeRecord) -> ComplianceResult:
    ...
    return ComplianceResult(
        ...
        section="Sec 5(3)",
        reason=(
            "available in English or Eighth Schedule language"
...
def check_notice(notice: NoticeRecord) -> ComplianceResult:
    ...
    return ComplianceResult(
        ...
        section="Sec 5",
        reason=(
            "all Sec 5 notice requirements satisfied"
            if all_pass
            else f"{len(failed)} of {len(sub)} requirement(s) failed: "
            + "; ".join(r.reason for r in failed)
        ),
        citation="DPDP Act 2023, Sec 5",
        sub_results=sub,
...
def check_legacy_notice(legacy: LegacyNoticeRecord) -> ComplianceResult:
    ...
    sub.append(
        ComplianceResult(
            ...
            section="Sec 5(2)(i)",
            reason=(
                "describes personal data processed"
                if legacy.describes_personal_data
    ...
    sub.append(
        ComplianceResult(
            ...
            section="Sec 5(2)(i)",
            reason=(
                "describes purpose for which data has been processed"
                if legacy.describes_purpose
    ...
    sub.append(
        ComplianceResult(
            ...
            section="Sec 5(2)",
            reason=(
                "legacy notice given after Act commencement date"
    ...
    sub.append(
        ComplianceResult(
            ...
            section="Sec 5(2)",
            reason=(
                "legacy notice given within reasonable time"
    ...
    return ComplianceResult(
        ...
        section="Sec 5(2)",
        reason=(
            "all Sec 5(2) legacy notice requirements satisfied"
            if all_pass
            else f"{len(failed)} of {len(sub)} legacy-notice requirement(s) failed: "
            + "; ".join(r.reason for r in failed)
        ),
        citation="DPDP Act 2023, Sec 5(2)",
        sub_results=sub,
